#
#  Be sure to run `pod spec lint UUNavigationController.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "neutronstarer"
  # spec.authors            = { "neutronstarer" => "neutronstarer@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/neutronstarer"
  ...
  spec.source       = { :git => "https://github.com/neutronstarer/UUNavigationController.git", :tag => "#{spec.version}" }
